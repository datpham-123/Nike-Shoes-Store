...
<div class="wrapper">
    ...
    <section class="main-content gallery">
        <div class="card card-tall gallery-item gallery-item--1">1</div>
        <div class="card gallery-item gallery-item--2">2</div>
        <div class="card card-wide gallery-item gallery-item--3">3</div>
        <div class="card gallery-item gallery-item--4">4</div>
        <div class="card gallery-item gallery-item--5">5</div>
        <div class="card card-wide gallery-item gallery-item--6">6</div>
        <div class="card card-tall gallery-item gallery-item--7">7</div>
        <div class="card card-wide gallery-item gallery-item--8">8</div>
        <div class="card gallery-item gallery-item--9">9</div>
        <div class="card gallery-item gallery-item--10">10</div>
        <div class="card gallery-item gallery-item--11">11</div>
        <div class="card card-wide gallery-item gallery-item--12">12</div>
    </section>
    <!-- end gallery -->
</div>
<!-- custom js -->
