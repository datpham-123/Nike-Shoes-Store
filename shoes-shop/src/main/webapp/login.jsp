    ...
    <section class="main-content login">
        <div class="login-wrapper">
            <div class="login-header">
                <h2 class="login-header__head">Create Account</h2>
            </div>
            <form action="#" class="form form-login" id="form-login">
                <div class="form-control">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" class="form-input form-input__text" id="username" name="username"
                           placeholder="Username"/>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check form-icon form-icon__success"
                    ...
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info form-icon form-icon__error"
                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <small class="form-error__message">error message</small>
                </div>
                <!-- end form control 1 -->
                <div class="form-control">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-input form-input__email" id="email" name="email"
                           placeholder="Email"/>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check form-icon form-icon__success"
                         fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="form-control">
                    ...
                    <input type="password" class="form-input form-input__text" id="password1" name="password1"
                ...
                <div class="form-control">
                    ...
                    <svg
                            ...
                            height="1em"
                            viewBox="0 0 16 16"
                            class="bi bi-check form-icon form-icon__success"
                            fill="currentColor"
                    ...
                    <svg
                            ...
                            height="1em"
                            viewBox="0 0 16 16"
                            class="bi bi-info form-icon form-icon__error"
                            fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                ...
                <div class="form-control">
                    <p>
                        <a href="register.jsp" class="form-link">Create an account</a>
                    </p>
                </div>
            </form>
        </div>
    </section>
    <!-- end main content login form -->
</div>
<!-- custom js -->
