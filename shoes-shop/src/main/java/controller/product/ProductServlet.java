...
public class ProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //1.2. Pagination settings (for All Products)
        pagiSet.paginationAll();
        ...
        listProduct = pdao.getProductPerPage((page * numberProduct) - numberProduct, numberProduct);
        ...
        request.setAttribute("pageMode", 1);
