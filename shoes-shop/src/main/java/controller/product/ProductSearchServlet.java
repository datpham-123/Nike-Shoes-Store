...
public class ProductSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //1.2. Pagination settings (for Searched Products only)
        pagiSet.paginationBySearch(searchProduct);
        ...
        listProduct = pdao.getProductPerPageBySearch((page * numberProduct) - numberProduct, numberProduct, searchProduct);
        ...
        request.setAttribute("pageMode", 2);
