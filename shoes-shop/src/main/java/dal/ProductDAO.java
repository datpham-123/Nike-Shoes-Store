...
public class ProductDAO implements IDAO<Product> {
    ...
    /**
     * @param list  List of all Products
     * @param start
     * @param end
     * @return SubList contain Products per page
     */

    public List<Product> getListProductPerPage(List<Product> list, int start, int end) {
...
//
////        List<Product> listSearch = pdao.getAllBySearch("phantom");
