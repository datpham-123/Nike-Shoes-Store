    ...
    <section class="main-content login">
        <div class="login-wrapper">
            ...
            <div class="login-header">
                <h2 class="login-header__head">Login</h2>
                <%--login status hidden message--%>
                <p style="margin-top: 1.5rem;">${requestScope.loginStatus}</p>
            </div>

            <%--form login--%>
            <form action="login" class="form form-login" id="form-login" method="post">
                ...
                <!-- end button -->
                <div class="form-control">
                    <p><a href="register.jsp" class="form-link">Create new account</a></p>

                    <%--hidden logout link--%>
                    <c:if test="${sessionScope.accountLogin ne null}">
                        <p style="margin-top: 1.5rem;">
                            <a href="${pageContext.request.contextPath}/logout" class="form-link">Logout</a>
                        </p>
                    </c:if>
                </div>
