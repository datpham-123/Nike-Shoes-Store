        ...
        <div class="login-wrapper">
            ...
            <form action="#" class="form form-login" id="form-login">
                <div class="form-control">
                    ...
                    <input type="text" class="form-input form-input__text" id="username" name="username" placeholder="Username" />
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check form-icon form-icon__success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                                fill-rule="evenodd"
                                d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"
                        />
                    </svg>
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-info form-icon form-icon__error" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="form-control">
                    ...
                    <input type="password" class="form-input form-input__text" id="password1" name="password1" placeholder="Password" />
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check form-icon form-icon__success" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
                                fill-rule="evenodd"
                                d="M10.97 4.97a.75.75 0 0 1 1.071 1.05l-3.992 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.236.236 0 0 1 .02-.022z"
                ...
                <!-- end button -->
                <div class="form-control">
                    <p><a href="login.jsp" class="form-link">Login</a></p>
                </div>
            </form>
        </div>
    </section>
