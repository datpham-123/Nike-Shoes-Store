    ...
    <section class="main-content login">
        <div class="login-wrapper">
            <div class="login-header">
                ...
                <%--hidden message--%>
                <p style="margin-top: 1rem;">${requestScope.accountRegistered}</p>
            </div>

            <%--login form start here--%>
            <form action="register" class="form form-login" id="form-login" method="post">
                <%--enter user name--%>
                ...
                <div class="form-control">
                    ...
                    <input
                            ...
                            name="email"
                            placeholder="Email"
                            class="form-input form-input__email"
                            required
                    />
                </div>
                <!-- end form control 2 -->
